...
gulp.task('watch', gulp.series('jshint', 'server', 'front-expose', 'copy-stress-test', 'ga', 'views', 'front-full', 'sass-full', function () {
    ...
    gulp.watch('src/client/views/*.html', gulp.series('ga'));
    gulp.watch('src/client/stressTest.js', gulp.series('copy-stress-test'));
    gulp.watch('src/sass/**/*.scss', gulp.series('sass-full'));
}));

gulp.task('default', gulp.parallel('jshint', 'server', 'front-expose', 'ga', 'views', 'front-min', 'sass-min'));
gulp.task('dev', gulp.parallel('jshint', 'server', 'front-expose', 'copy-stress-test', 'ga', 'views', 'front-full', 'sass-full'));
